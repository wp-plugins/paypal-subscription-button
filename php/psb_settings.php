...
if( !class_exists( 'psb_Settings' ) ) {
	...
	class psb_Settings {
		...
		function create_menu() {
			...
			$page = add_menu_page( 'PSB', 'PSB', 'administrator', __FILE__, array( &$this, 'print_settings' ), 
		...
		function init_options() {
			if( class_exists( 'psb_Options' ) ) {
				...
				if( isset( $this->post_vars[ 'updatepsboptions' ] ) && $this->post_vars[ 'updatepsboptions' ] == true ) {
				...
				<form method="post" action="">
                    ...
                    <ul class="input-align subtitle-margin">
                        ...
                        <li><span class="title">Payment currency</span>
                        	...
                        	<input id="currency" maxlength="150" size="40" name="currency" 
                        	   	   value="<?php echo $this->option_values[ 'currency' ]; ?>" />
                        </li>    
                    </ul> 
                    ...
                    <ul class="input-align subtitle-margin">
                        <li><span class="title">Instant Paypal Notification(IPN) page</span>
                        	...
                        	<input name="autoset_ipn_page" type="radio" 
									   value="1" <?php checked( '1', $this->option_values[ 'autoset_ipn_page' ] ); ?> />
							<label> Automatically setup the page ( Recommended ) </label> 
                            <input name="autoset_ipn_page" type="radio" 
									   value="0" <?php checked( '0', $this->option_values[ 'autoset_ipn_page' ] ); ?> />
                    ...
                    <ul class="m-types input-align subtitle-margin">
                        <li><span class="title">Membership types</span>
                        	...
                        	<?php
							$m_types = $this->option_values[ 'custom_roles' ];
							if( is_array( $m_types ) ) {
